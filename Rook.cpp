...
//default constructor
Rook::Rook(const string& color, const int& row, const int& column, const bool& movingUp, const int& castleMoves) : ChessPiece(color, row, column, movingUp), castle_moves_left_(castleMoves < 0 ? 0 : castleMoves) {
